export const generalStyle = "absolute top-0 left-0 right-0 bottom-0 text-center h-full p-3 bg-gray-800 text-gray-100 text-lg"
...
export const registrationLabelStyle = "block text-gray-700 text-sm font-bold mb-2";
